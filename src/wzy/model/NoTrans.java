...
public class NoTrans extends EmbeddingModel{
	...
	public double CalculateSimilarity(int[] triplet)
	{
		...
		for(int i=0;i<entity_dim;i++)
		{
			sum+=(entityEmbedding[triplet[0]][i]+relationEmbedding[triplet[1]][i])
					*(entityEmbedding[triplet[2]][i]-relationEmbedding[triplet[1]][i]);
		}
	...
	protected void CalculateGradient(int[] triplet)
	{
		...
		if(truesimi+margin-falsesimi>0)
		{
			for(int i=0;i<entity_dim;i++)
			{
				entityGradient[triplet[0]][i]-=entityEmbedding[triplet[2]][i]-relationEmbedding[triplet[1]][i];
				relationGradient[triplet[1]][i]-=entityEmbedding[triplet[2]][i]-entityEmbedding[triplet[0]][i]-2*relationEmbedding[triplet[1]][i];
				entityGradient[triplet[2]][i]-=entityEmbedding[triplet[0]][i]+relationEmbedding[triplet[1]][i];
				
				entityGradient[ftriplet[0]][i]+=entityEmbedding[ftriplet[2]][i]-relationEmbedding[ftriplet[1]][i];
				relationGradient[ftriplet[1]][i]+=entityEmbedding[ftriplet[2]][i]-entityEmbedding[ftriplet[0]][i]-2*relationEmbedding[ftriplet[1]][i];
